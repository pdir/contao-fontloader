 ...
 */
$GLOBALS['BE_MOD']['design']['fontgroup'] = array
(
    'tables'       => array('tl_font_group', 'tl_font_src'),
    'icon'         => 'system/modules/fontloader/assets/icon.png',
);
...
if (TL_MODE == 'BE') {
    ...
    $GLOBALS['TL_CSS'][] = '/system/modules/fontloader/assets/css/be.css';
}
...
if (TL_MODE == 'BE')
{
    ...
    array_unshift($GLOBALS['TL_JAVASCRIPT'], 'system/modules/fontloader/assets/js/jquery.noconflict.js');
...
$GLOBALS['TL_HOOKS']['getPageLayout'][] = array('Pdir\FontLoader', 'hookGetPageLayout');
